...
# orig_metrics.py
"""
Computes every "*_orig" metric ONCE per sample.
...
def compute_orig_metrics(wasm_path, wabt_bins, wasmtime_bin, browser_runner_js,
                          ...
                          ghidra_timeout=300, node_path=None):
    """
    ...
    # native run (wasmtime/wasmer), parameter-aware, _start preferred over
    # other exports since some obfuscators/mutators rename exported symbols
