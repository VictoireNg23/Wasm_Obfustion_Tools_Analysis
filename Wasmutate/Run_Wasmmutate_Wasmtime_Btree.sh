...
ORIG_WASM_DIR="./btree"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/btree"
RESULTS_DIR="./WasmMutate/WasmMutate_Results/btree/Results_btree"
CSV_FILE="./WasmMutate/WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/btree.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/btree.log"
