...
ORIG_WASM_DIR="$BASE_DIR/mining_programs"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/mining_programs"
RESULTS_DIR="$MUT_WASM_DIR/Results_mining_programs_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/mining_programs.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/mining_programs.log"
