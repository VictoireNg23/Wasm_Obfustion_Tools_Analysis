...
ORIG_WASM_DIR="./Wasm/Dataset_officiel_wasm/Mineray"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/Mineray"
RESULTS_DIR="$MUT_WASM_DIR/Results_Mineray_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/Mineray.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/Mineray.log"
