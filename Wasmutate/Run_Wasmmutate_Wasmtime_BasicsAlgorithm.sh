...
ORIG_WASM_DIR="./basic-algorithms"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/Basics_Algorithm"
RESULTS_DIR="./WasmMutate_Results/Basics_Algorithm/Results_Basics_Algorithm"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/Basic_Algorithms.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/Basics_Algorithm.log"
