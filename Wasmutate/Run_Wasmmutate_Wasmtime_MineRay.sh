...
ORIG_WASM_DIR="./Mineray"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/Mineray"
RESULTS_DIR="./WasmMutate/WasmMutate_Results/Mineray/Results_Mineray"
CSV_FILE="./WasmMutate/WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/Mineray.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/Mineray.log"
...
# === WASM Runtime ===
WASM_RUNTIME="wasmtime"      # <<< SEUL CHANGEMENT
