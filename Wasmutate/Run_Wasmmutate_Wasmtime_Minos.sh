...
ORIG_WASM_DIR="./Minos"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/Minos"
RESULTS_DIR="./WasmMutate/WasmMutate_Results/Minos/Results_Minos"
CSV_FILE="./WasmMutate/WasmMutate_Results/Results_Csv/Minos.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/Minos.log"
