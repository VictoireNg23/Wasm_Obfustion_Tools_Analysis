...
ORIG_WASM_DIR="$BASE_DIR/basic-algorithms"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/Basics_Algorithm"
RESULTS_DIR="$MUT_WASM_DIR/Results_basic_algorithms_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/Basic_Algorithms.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/Basics_algorithm.log"
