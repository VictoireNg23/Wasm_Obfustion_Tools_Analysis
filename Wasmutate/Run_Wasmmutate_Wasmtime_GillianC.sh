...
ORIG_WASM_DIR="./GillianC"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/GillianC"
RESULTS_DIR="./WasmMutate/WasmMutate_Results/GillianC/Results_GillianC"
CSV_FILE="./WasmMutate/WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/GillianC.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/GillianC.log"
