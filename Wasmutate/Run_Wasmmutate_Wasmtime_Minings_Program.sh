...
ORIG_WASM_DIR="./mining_programs"
MUT_WASM_DIR="./WasmMutate/WasmMutate_Results/mining_programs"
RESULTS_DIR="./WasmMutate/WasmMutate_Results/mining_programs/Results_mining_programs"
CSV_FILE="./WasmMutate/WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/mining_programs.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/mining_programs.log"
