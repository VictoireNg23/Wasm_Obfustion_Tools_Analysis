...
ORIG_WASM_DIR="$BASE_DIR/btree_manticore"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/btree_manticore"
RESULTS_DIR="$MUT_WASM_DIR/Results_btree_manticore_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/btree_manticore.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/btree_manticore.log"
