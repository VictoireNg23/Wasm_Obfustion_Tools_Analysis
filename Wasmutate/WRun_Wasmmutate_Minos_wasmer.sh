...
ORIG_WASM_DIR="./Wasm/Dataset_officiel_wasm/Minos"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/Minos"
RESULTS_DIR="$MUT_WASM_DIR/Results_Minos_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/Minos.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/Minos.log"
