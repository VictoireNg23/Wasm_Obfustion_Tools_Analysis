...
ORIG_WASM_DIR="$BASE_DIR/realworld_program"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/realworld_program"
RESULTS_DIR="$MUT_WASM_DIR/Results_realworld_program_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/realworld_program.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/realworld_program.log"
...
already_done() {
    ...
    # Vérifie si cette ligne existe déjà dans le CSV
    grep -q "^$sample,.*,$combo,$mutant_id," "$CSV_FILE"
}
