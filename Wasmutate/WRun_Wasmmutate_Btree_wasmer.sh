...
ORIG_WASM_DIR="$BASE_DIR/btree"
MUT_WASM_DIR="./Wasmutate/WasmMutate_Results_wasmer/btree"
RESULTS_DIR="$MUT_WASM_DIR/Results_btree_wasmer"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmer/btree.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmer/btree.log"
