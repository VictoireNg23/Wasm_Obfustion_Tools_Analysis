...
ORIG_WASM_DIR="./btree_manticore"
MUT_WASM_DIR="./WasmMutate_Results/btree_manticore"
RESULTS_DIR="./WasmMutate_Results/btree_manticore/Results_btree_manticore"
CSV_FILE="./WasmMutate_Results/Results_Csv/Results_Spectec_Wasmutate_Wasmtime/btree_manticore.csv"
LOG_FILE="$MUT_WASM_DIR/Log_wasmtime/btree_manticore.log"

MUTATOR="./wasm_mutator_by_category/target/release/wasm_mutator_by_category"
NODE_PUPPET="./run_browser_test.js"
